                    ...
                    <tr>
                      <td bgcolor="" class="" style="width:100% !important; padding: 0;">
                        <custom type="content" name="hero_image">
                          ...
                          <table cellspacing="0" cellpadding="0" align="left" border="0" width="100%" bgcolor="#ffffff">
                            <tr>
                              <td valign="top" align="center" width="100%" style="padding-right: 50px; padding-left: 50px;">
                                <img width="100%" style="max-width: 600px; height: auto" src="https://cdn.discordapp.com/attachments/950840744745263174/957247192534499379/unknown.png" alt="Lyft business profile" />
                              </td>
                            </tr>
                          </table>
                            ...
                            <tr>
                              <td align="center" style="padding: 0 25px 30px 25px; background-color: #ffffff;">
                                <table align="center" cellpadding="0" cellspacing="0" border="0" class="full-width">
                                  <tr>
                                    <td class="cta-shadow" align="center" bgcolor="#00bbf9" style="border-radius: 40px; -webkit-border-radius: 40px; -moz-border-radius: 40px;">
...
module.exports = { getEmailStringPw };
